---
titulo: Anatomia do trabalho invisível
resumo: As quatro categorias de trabalho que consomem o dia antes de qualquer conversa acontecer — e por que a automação anterior não resolveu nenhuma delas.
slide:
  layout: default
notas: |
...
**Pesquisa** é a busca por contexto que ainda não existe em lugar nenhum da empresa. Alguém lê
um release, descobre uma mudança de liderança, entende que a empresa abriu um escritório novo.
É trabalho de leitura e julgamento.

**Enriquecimento** é diferente: o dado existe, só está espalhado. Está em três sistemas que
não se falam, em formatos incompatíveis, com chaves que não batem. É trabalho de junção.

**Higiene de CRM** é o imposto. Ninguém foi contratado para isso e todo mundo faz — mal, com
atraso, e frequentemente duas vezes. É a origem da maior parte da desconfiança que times
comerciais têm dos próprios dados.
...
destinatário aprende a reconhecer o padrão em dois segundos.
...
preço, quem chegou perto de comprar e não comprou, quem já está em negociação e não pode ser
abordado de novo.

Canal novo, trabalho invisível novo. É por isso que essa palestra tem dois exemplos e não um.
