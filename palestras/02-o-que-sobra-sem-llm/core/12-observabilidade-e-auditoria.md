...
<!-- slide -->
## Auditoria é o mesmo dado, com outro requisito

- Chat no banco, não no agente → histórico sobrevive a qualquer redeploy
- Run + logs no banco → "o que o agente fez às 3h da manhã" tem resposta
- Billing por interação (próxima seção) → "quanto custou" tem resposta
- Tudo indexado por empresa, usuário, playbook e run
<!-- /slide -->
